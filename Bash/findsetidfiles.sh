...
echo "Setuid files:"
echo "============="
find / -type f -exec ls -lh {} + 2>/dev/null | sort -k 5 -hk 5 -r | head -n 12 | awk '{print $4, $5, $9}'
echo "============="
echo "Thats all"
...
#sudo du -ah / | find / -type f -executable -perm -4000 -ls 2>/dev/null | sort -n -r | head -n 12
